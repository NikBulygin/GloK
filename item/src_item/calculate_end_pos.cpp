...
void item::calculate_end_pos()
{
    ...
    rotationMatrix.rotate(this->get_x_rotate(), 1, 0, 0); // Поворот вокруг оси X
    rotationMatrix.rotate(this->get_y_rotate(), 0, 1, 0); // Поворот вокруг оси Y
    rotationMatrix.rotate(this->get_z_rotate(), 0, 0, 1); // Поворот вокруг оси Z
